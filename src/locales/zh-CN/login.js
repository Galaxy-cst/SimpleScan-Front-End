export default {
  ...
  'app.login.password': '口令',
  'app.login.message-invalid-credentials': '账户或口令错误（admin/ant.design）',
  'app.login.message-invalid-verification-code': '验证码错误',
  'app.login.tab-login-credentials': '账户口令登录',
  'app.login.tab-login-mobile': '手机号登录',
  'app.login.remember-me': '自动登录',
  'app.login.forgot-password': '忘记口令',
  ...
  'app.login.verification-code-warning':
    '此项目为演示项目，并不会真的给您发送验证码。请切换到账户口令登录界面按提示登录。',
  ...
  'validation.password.required': '请输入口令！',
  'validation.password.twice': '两次输入的口令不匹配!',
  'validation.password.strength.msg': '请至少输入 6 个字符。请不要使用容易被猜到的口令。',
  'validation.password.strength.strong': '强度：强',
  'validation.password.strength.medium': '强度：中',
  'validation.password.strength.short': '强度：太短',
  'validation.confirm-password.required': '请确认口令！',
